...
function Journalscreen(){
    ...
    return(
        ...
        <NavLink onClick={toggleModal} className="text-white text-[12px] md:text-sm lg:text-sm bg-gradient-to-b from-orange-400/55 to-orange-600 hover:bg-orange-600/45 p-2 px-7 md:px-10 lg:px-10 font-medium duration-300 rounded-md items-center justify-center"> Sign in</NavLink>
