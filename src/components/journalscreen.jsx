...
function Journalscreen(){
    ...
    return(
        ...
        <NavLink onClick={toggleModal} className="text-white text-[12px] md:text-sm lg:text-sm bg-gradient-to-b from-orange-400/65 to-orange-600 hover:bg-orange-600/45 p-2 px-7 md:px-10 lg:px-10 font-medium duration-300 rounded-md items-center justify-center"> Sign in</NavLink>
        <NavLink onClick={toggleModal} className="text-slate-600 text-[12px] md:text-sm lg:text-sm bg-gradient-to-b from-slate-100 to-slate-300 p-2 px-7 md:px-10 lg:px-10 font-medium hover:bg-slate-300 duration-300 rounded-md items-center justify-center"> Sign up</NavLink>
        </div>    
