...
function Journalscreen(){
    ...
    return(
        ...
        <NavLink onClick={toggleModal} className="text-white text-[12px] md:text-sm lg:text-sm bg-orange-600/55 hover:bg-orange-600/45 p-2 px-6 md:px-10 lg:px-10 font-medium duration-300 rounded-md items-center justify-center"> Sign in</NavLink>
        <NavLink onClick={toggleModal} className="text-slate-600 text-[12px] md:text-sm lg:text-sm bg-slate-200 p-2 px-6 md:px-10 lg:px-10 font-medium hover:bg-slate-300 duration-300 rounded-md items-center justify-center"> Sign up</NavLink>
        </div>    
