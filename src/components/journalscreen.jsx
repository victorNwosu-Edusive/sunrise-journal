    ...
    return(
         ...
         */}
         ...
         <div className='rounded-2xl m-2 lg:m-5 h-auto lg:h-screen w-screen bg-hero-pattern bg-orange-700/40 bg-blend-overlay bg-cover bg-no-repeat bg-center pt-72 lg:pt-44 p-7 lg:p-10'>
            ...
            <p className='text-white font-bold mt-6 text-sm md:text-3xl lg:text-3xl drop-shadow-[0_0_2px_rgba(255,255,255,0.8)]'>Your Journey to <span className='text-2xl lg:text-5xl md:text-5xl font-global font-thin' >{words[index]}</span></p>
