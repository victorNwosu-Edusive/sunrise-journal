...
const Login = () => {
  ...
  return (
    <div className='flex gap-6 flex-col p-10 items-center'>
        ...
        <div className='px-4 overflow-hidden border-2 duration-200 outline-none  focus:border-orange-400 w-full  border-orange-500 rounded-full flex items-center justify-center gap-4'> <FontAwesomeIcon icon={faUserCircle} className='text-orange-500' /> <input type="text" className='placeholder-orange-700/35 w-full p-3 text-sm outline-none '  placeholder='Username' /></div>
        <div className='px-4 overflow-hidden border-2 duration-200 outline-none  focus:border-orange-400 w-full text-sm border-orange-500 rounded-full flex items-center justify-center gap-4'> <FontAwesomeIcon icon={faLock} className='text-orange-500' /> <input type="password" className='placeholder-orange-700/35 w-full p-3 text-sm outline-none '  placeholder='Password' /></div>
