...
const Login = () => {
  ...
  return (
    <div className='flex gap-6 flex-col p-10 items-center'>
        ...
        <div className='px-4 overflow-hidden border-2 duration-200 outline-none placeholder-orange-700/35 focus:border-orange-400 w-full text-sm border-orange-700 rounded-full flex items-center justify-center gap-4'> <FontAwesomeIcon icon={faUserCircle} className='text-orange-700' /> <input type="text" className='w-full p-3 outline-none '  placeholder='Username' /></div>
        <div className='px-4 overflow-hidden border-2 duration-200 outline-none placeholder-orange-700/35 focus:border-orange-400 w-full text-sm border-orange-700 rounded-full flex items-center justify-center gap-4'> <FontAwesomeIcon icon={faLock} className='text-orange-700' /> <input type="password" className='w-full p-3 outline-none '  placeholder='Password' /></div>
