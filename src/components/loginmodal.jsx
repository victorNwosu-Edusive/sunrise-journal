    ...
    const handleAuth = async (e) => {
        ...
        try {
            if (isSignUp) {
                ...
                // Handle Login
                const usernameQuery = doc(db, "usernames", username); // Adjust if username mapping is not by ID
                ...
                const userEmail = usernameSnapshot.data().email;
                await signInWithEmailAndPassword(auth, userEmail, password);
    
                alert("Login successful!");
            }
    
            navigate("/saved-journal"); // Ensure this line executes
            onClose();
        } catch (err) {
